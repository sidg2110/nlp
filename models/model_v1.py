...
class TaxoExpan():
    ...
    def __init__(self, term_embeddings: torch.Tensor, device='cpu'):
        self.device = device
        self.term_embeddings = term_embeddings.to(device)
    ...
    def predict_parents(self, eval_concepts: torch.Tensor, concepts: List[str]) -> List[str]:
        ...
        normalized_terms = F.normalize(self.term_embeddings, p=2, dim=1)
